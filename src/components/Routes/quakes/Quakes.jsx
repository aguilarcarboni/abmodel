  ...
  return (
    <div className='quakesContainer'>
        <div className='information'>
          <div className='block'>
            <h1 className='title'>Earthquakes</h1>
            <h3 className='subtitle'>What are earthquakes?</h3>
            <p className='text'>An earthquake is an intense shaking of Earth's surface produced by a release of accumulated
            ...
            <h3 className='subtitle'>How do we measure earthquakes?</h3>
            <p className='text'>To detect earthquakes, instruments called seismometers are used, which measure seismic waves
            ...
            <h3 className='subtitle'>Do earthquakes only happen on earth?</h3>
            <p className='text'>Earth isn’t the only place where there is seismic activity. Scientists have also measured quakes
          ...
          <div className='block'>
            <h1 className = 'title'>Moonquakes</h1>
              <h3 className='subtitle'>How do we detect moonquakes?</h3>
              <p className='text'>A technique involves an instrument that responds to ground surface movements by vibrating.
              ...
              <h3 className='subtitle'>What types of events have been detected?</h3>
              <p className='text'>It can be classificated as:
              ...
              <h3 className='subtitle'>Does an earthquake feel different from a moonquake?</h3>
              <p className='text'>Yes, because seismic waves are attenuated much less on the Moon than they are on Earth.
              ...
              <h3 className='subtitle'>How long does a moonquake last?</h3>
              <p className='text'>It can last from minimum 10 minutes up to an hour, but it has been registered a moonquake
                duration of 5 hours.
              </p>
          </div>
        </div>
